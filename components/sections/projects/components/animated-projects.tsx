      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            ...
            <div 
            className="text-sm text-gray-500 dark:text-neutral-500 flex gap-2"
            >
              {projects[active].tags.map((tag, index) => {
                return(
                  <ProjectTag key={index} position={index} tag={tag} />
                )
              })}
            </div>
            <motion.p className="mt-8 text-lg text-gray-950 dark:text-neutral-300">
